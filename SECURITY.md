...
### Next.js Security Updates (Latest: v14.2.35)

#### Critical DoS Vulnerabilities Patched
**Date**: February 16, 2026  
**Action**: Upgraded Next.js from 14.2.15 to 14.2.35

**Vulnerabilities Fixed**:
1. **DoS with Server Components** (CVE)
...
2. **Authorization Bypass in Middleware** (CVE)
   ...
   - Patched in: 14.2.25 (included in 14.2.35)
   - Severity: High
   - Description: Middleware authorization could be bypassed in certain configurations

**Resolution**: Updated to Next.js 14.2.35 which includes patches for all known vulnerabilities in the 14.x line.
...
### Update History
- **2026-02-16**: Upgraded Next.js 14.2.15 → 14.2.35 (DoS vulnerabilities)
